...
export function ImageListPage(props: ImageListPageProps) {
  ...
  const columns: ColumnType[] = [
    { id: 'original_size', header: 'original_size', accessorKey: 'original_size' },
    { id: 'upscaled_size', header: 'upscaled_size', accessorKey: 'upscaled_size' },
    { id: 'upscale_factor', header: 'upscale_factor', accessorKey: 'upscale_factor' },
