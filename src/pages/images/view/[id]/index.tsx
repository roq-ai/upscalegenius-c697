        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Original Size" text={data?.original_size} />

                <FormListItem label="Upscaled Size" text={data?.upscaled_size} />

                <FormListItem label="Upscale Factor" text={data?.upscale_factor} />
