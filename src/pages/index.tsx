...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`UpscaleGenius`}</title>

        <meta
          name="description"
          content="Experience the power of AI with UpscaleGenius, your ultimate image upscaling app. Enhance your images up to X4 without losing quality, perfect for photographers, designers, and printing needs. User-friendly and integrated with top automation platforms for effortless workflow."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1625314887424-9f190599bd56?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBSXxlbnwwfHx8fDE2OTM2NjY3ODJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of AI with UpscaleGenius, your ultimate image upscaling app. Enhance your images up to X4 without losing quality, perfect for photographers, designers, and printing needs. User-friendly and integrated with top automation platforms for effortless workflow.`}
            </Text>
            <Box
